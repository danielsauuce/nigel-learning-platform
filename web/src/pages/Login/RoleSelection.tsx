      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <h3 className="text-3xl font-bold text-[#22223B] mb-4">
              I'm a Student
            </h3>
            <p className="text-gray-500 font-medium leading-relaxed mb-8">
              Access your courses, play educational games, and track your
              learning journey.
            </p>
          ...
          >
            ...
            <p className="text-white/50 font-medium leading-relaxed mb-8">
              Manage your classes, create new content, and monitor student
              performance.
            </p>
