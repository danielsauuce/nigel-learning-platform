          ...
          {step === 'consent' && (
            ...
            >
              <div className="text-center space-y-3">
                ...
                >
                  You can share a summary of your progress with a parent or
                  guardian. They'll get a read-only link that expires in 7 days.
                </p>
              </div>
              ...
              >
                ...
                <span className="text-xs text-gray-400">
                  The link will expire after 7 days. You can revoke access at
              ...
              >
                ...
                <span
                  className={`flex-1 text-sm font-medium ${dark ? 'text-gray-300' : 'text-[#22223B]'}`}
                >
                  I understand what will be shared and I want to generate a link
                  for my parent or guardian.
                </span>
              </button>
            ...
            >
              <div className="text-center space-y-3">
                ...
                <p
                  className={`text-sm font-medium ${dark ? 'text-gray-400' : 'text-gray-500'}`}
                >
                  Share this link with your parent or guardian so they can see
                  your progress.
                </p>
              </div>
                    ...
                    {[
                      {
                        ...
                        label: 'Missions',
                        value: `${learning.completedLessons.size}/33`,
                      },
                      {
                        icon: (
