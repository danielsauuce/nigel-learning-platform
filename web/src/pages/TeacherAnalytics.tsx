    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 lg:ml-80 p-6 md:p-12 overflow-y-auto">
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
          <div className="flex items-center gap-4">
            ...
            <div className="space-y-1">
              <h1 className="text-3xl font-bold text-[#22223B]">Analytics & Insights</h1>
              <p className="text-gray-500 font-medium">Track student progress and class performance.</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {[
            { label: "Average Score", value: "86.4%", trend: "+2.5%", icon: <Award className="w-6 h-6" />, color: "text-[#B9A7F8]" },
            { label: "Engagement Rate", value: "92%", trend: "+5.1%", icon: <TrendingUp className="w-6 h-6" />, color: "text-[#F7B6B6]" },
            { label: "Study Hours", value: "1,240h", trend: "-1.2%", icon: <Clock className="w-6 h-6" />, color: "text-[#FFD93D]" },
          ].map((stat, i) => (
            <motion.div 
              key={i}
            ...
            >
              ...
              <h3 className="text-4xl font-bold text-[#22223B]">{stat.value}</h3>
            </motion.div>
          ))}
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          >
            <div className="flex justify-between items-center mb-10">
              <h3 className="text-2xl font-bold text-[#22223B]">Weekly Performance</h3>
              ...
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={performanceData}>
                  ...
                  <Line 
                    ...
                    stroke="#B9A7F8" 
                    strokeWidth={4} 
                    dot={{ r: 6, fill: '#B9A7F8', strokeWidth: 2, stroke: '#fff' }}
                    activeDot={{ r: 8 }}
                  />
                </LineChart>
              </ResponsiveContainer>
          ...
          <motion.div 
            ...
            className="bg-white p-10 rounded-[4rem] shadow-sm border border-gray-100"
          >
            <h3 className="text-2xl font-bold text-[#22223B] mb-10">Subject Proficiency</h3>
            <div className="h-[300px] w-full">
              <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-white/60 leading-relaxed font-medium">
                Our AI has analyzed your students' performance across all modules. Students are showing exceptional growth in <span className="text-[#FFD93D]">Visual Arts</span> but may need more support in <span className="text-[#F7B6B6]">Scientific Reasoning</span>.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="bg-white/5 backdrop-blur-md p-6 rounded-3xl border border-white/10">
                  <p className="text-white/40 text-xs font-bold uppercase mb-1">{item.label}</p>
