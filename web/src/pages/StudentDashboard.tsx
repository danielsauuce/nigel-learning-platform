        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className={`w-12 h-12 rounded-2xl flex items-center justify-center shadow-sm transition-colors ${dark ? 'bg-[#2A2A40] text-gray-400 hover:text-white' : 'bg-white text-gray-400 hover:text-[#22223B]'}`}
            >
              <Settings className="w-6 h-6" />
            </button>
            <div
              className={`flex items-center gap-4 p-4 rounded-[2rem] shadow-sm border ${dark ? 'bg-[#2A2A40] border-[#3A3A55]' : 'bg-white border-gray-100'}`}
            >
          ...
          <div className="lg:col-span-2 space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {missions.map((mission) => (
                  ...
                  >
                    ...
                    <div
                      className={`${mission.color} w-14 h-14 rounded-2xl flex items-center justify-center text-white mb-6 shadow-lg`}
                    >
                      {mission.icon}
                    </div>
                    <h3
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        <div
                          className={`${mission.color} h-full transition-all duration-1000`}
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
                <div className="flex-1 space-y-4">
                  ...
                  <p className="text-gray-300 font-medium">
                    Pick a career, receive your payslip, and allocate your
                    monthly budget — then survive a surprise life event!
                  </p>
                  <button
            ...
            >
              ...
              <div>
                ...
                >
                  Divide your income into Needs (50%), Wants (30%), and Savings
                  (20%).
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-4">
                {displayBadges.map((badge) => (
                  ...
                  >
                    <div
                      className={`w-16 h-16 rounded-3xl flex items-center justify-center text-3xl shadow-sm group-hover:scale-110 transition-transform ${dark ? 'bg-[#1A1A2E]' : 'bg-amber-100'}`}
                    >
                      {badge.emoji}
                    </div>
                ...
                {displayBadges.length < 3 && (
                  <div
                    className={`w-16 h-16 rounded-3xl border-2 border-dashed flex items-center justify-center ${dark ? 'border-[#3A3A55] text-gray-600' : 'border-gray-100 text-gray-200'}`}
                  >
