    ...
    <div className="min-h-screen bg-[#F8F9FE] p-6 md:p-10">
      <div className="max-w-4xl mx-auto">
        <header className="flex items-center gap-4 mb-10">
          ...
          <div>
            <h1 className="text-2xl font-black text-[#22223B]">
              Budget Simulator
            </h1>
            <p className="text-gray-500 font-medium text-sm">
              Experience your first month of earning!
            </p>
          </div>
        </header>
        ...
        <AnimatePresence mode="wait">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {JOBS.map((j) => (
                  ...
                  >
                    ...
                    <h3 className="text-xl font-black text-[#22223B] mb-2">
                      {j.title}
                    </h3>
                    ...
                    <div className="pt-4 border-t border-gray-50">
                      ...
                      <p className="text-2xl font-black text-[#22223B]">
                        {j.salary}
                      </p>
                    </div>
                  </button>
          ...
          {step === 'payslip' && (
            <motion.div
              ...
              className="bg-white p-10 md:p-16 rounded-[4rem] shadow-2xl border border-gray-100 max-w-2xl mx-auto relative overflow-hidden"
            >
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between items-center mb-1">
                          ...
                          <span className="font-black text-[#B9A7F8]">
                            £{cat.value}
                          </span>
                        </div>
                        ...
                        <input
                          ...
                          value={cat.value}
                          onChange={(e) =>
                            updateBudget(cat.key, parseInt(e.target.value))
                          }
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="w-full bg-white/10 h-3 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${Math.min(100, (totalSpent / TAKE_HOME) * 100)}%`,
                          }}
                        />
                      </div>
                    </div>
          ...
          {step === 'event' && event && (
            ...
            >
              ...
              <div className="bg-rose-50 p-6 rounded-3xl border border-rose-100">
                <p className="text-rose-500 font-black text-2xl">
                  -£{event.cost}
                </p>
          ...
          {step === 'results' && (
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div
                  className={`p-8 rounded-[3rem] border text-center ${finalBalance >= 0 ? 'bg-blue-50 border-blue-100' : 'bg-rose-50 border-rose-100'}`}
                >
                  <p
                    className={`font-black text-3xl ${finalBalance >= 0 ? 'text-blue-600' : 'text-rose-600'}`}
                  >
                    £{finalBalance}
                  </p>
                  <p
                    className={`text-[10px] font-bold uppercase tracking-widest ${finalBalance >= 0 ? 'text-blue-500/60' : 'text-rose-500/60'}`}
                  >
                    Final Balance
                  </p>
                </div>
