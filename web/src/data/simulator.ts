...
export const LIFE_EVENTS = [
  {
    title: 'Phone Screen Smashed!',
    cost: 80,
    desc: "Oops! You dropped your phone. That's going to cost you.",
  },
  {
    title: "Friend's Birthday!",
    cost: 30,
    desc: 'You forgot you needed to buy a gift for your best mate.',
  },
  {
    title: 'Train Strike!',
    cost: 20,
    desc: 'You had to take an expensive taxi to get to work.',
  },
  {
    title: 'Boiler Breakdown!',
    cost: 120,
    desc: "Your heating broke! Cold showers until it's fixed.",
  },
  {
    title: 'Surprise Vet Bill!',
    cost: 90,
    desc: 'Your pet needed an emergency vet visit.',
  },
]
