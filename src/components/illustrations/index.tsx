...
export function IslandIllustration() {
  return (
    <Svg width={160} height={140} viewBox="0 0 160 140">
      <Path d="M10 105 Q40 95 80 105 Q120 115 150 105 L150 130 Q120 120 80 130 Q40 140 10 130 Z" fill="#4FC3F7" opacity={0.35} />
      <Path d="M0 112 Q35 102 75 112 Q115 122 155 110" fill="none" stroke="#4FC3F7" strokeWidth="2" opacity={0.25} />
      <Path d="M30 105 Q50 70 80 75 Q110 70 130 105 Z" fill="#8BC34A" />
      <Path d="M38 105 Q55 82 80 85 Q105 82 122 105 Z" fill="#FFE082" />
      <Path d="M78 75 Q74 50 70 28" stroke="#8D6E63" strokeWidth="5" strokeLinecap="round" fill="none" />
...
export function TrophyIllustration() {
  return (
    <Svg width={160} height={140} viewBox="0 0 160 140">
      ...
      <Path d="M55 35 L55 80 Q55 95 80 95 Q105 95 105 80 L105 35 Z" fill="none" stroke="#E8960C" strokeWidth="2" />
      <Path d="M55 45 Q35 45 35 60 Q35 75 55 75" fill="none" stroke="#E8960C" strokeWidth="3" strokeLinecap="round" />
      <Path d="M105 45 Q125 45 125 60 Q125 75 105 75" fill="none" stroke="#E8960C" strokeWidth="3" strokeLinecap="round" />
      <Path d="M80 50 L83 59 L93 59 L85 65 L88 74 L80 68 L72 74 L75 65 L67 59 L77 59 Z" fill="#FFFFFF" opacity={0.9} />
...
export function IslandIcon() {
  return (
    <Svg width={120} height={100} viewBox="0 0 120 100">
      <Path d="M10 75 Q30 68 60 75 Q90 82 110 75 L110 95 Q90 88 60 95 Q30 102 10 95 Z" fill="#4FC3F7" opacity={0.5} />
      <Path d="M25 75 Q40 55 60 58 Q80 55 95 75 Z" fill="#8BC34A" />
      <Path d="M30 75 Q45 65 60 67 Q75 65 90 75 Z" fill="#FFE082" />
      <Path d="M58 58 Q55 40 52 25" stroke="#8D6E63" strokeWidth="4" strokeLinecap="round" fill="none" />
