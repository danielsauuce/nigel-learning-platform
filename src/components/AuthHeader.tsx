...
export function AuthHeader({ emoji, title, subtitle }: AuthHeaderProps) {
  return (
    <Animated.View entering={FadeInDown.duration(700)} className="items-center mb-10">
      <Text className="text-6xl mb-4">{emoji}</Text>

      <Text className="text-4xl font-bold text-foreground mb-2 text-center">{title}</Text>
