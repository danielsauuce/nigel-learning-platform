  ...
  return (
    ...
    >
      <Svg width={size} height={size} viewBox="0 0 40 40">
        <Defs>
          <SvgLinearGradient id={`trCoin-${delay}`} x1="0" y1="0" x2="0" y2="1">
...
const PersonIcon = () => (
  <Svg width={20} height={20} viewBox="0 0 20 20">
    ...
    <Path
      d="M3 18 Q3 13 10 12 Q17 13 17 18"
      fill="none"
...
const SchoolIcon = () => (
  <Svg width={20} height={20} viewBox="0 0 20 20">
    <Path
      d="M2 18 L2 9 L10 4 L18 9 L18 18"
      fill="none"
      stroke="rgba(255,255,255,0.35)"
      strokeWidth="1.5"
      strokeLinecap="round"
...
const LockIcon = () => (
  <Svg width={20} height={20} viewBox="0 0 20 20">
    ...
    />
    <Path
      d="M7 9 L7 6 Q7 3 10 3 Q13 3 13 6 L13 9"
      fill="none"
      stroke="rgba(255,255,255,0.35)"
      strokeWidth="1.5"
      strokeLinecap="round"
...
const EyeIcon = ({ visible }: { visible: boolean }) => (
  <Svg width={22} height={22} viewBox="0 0 22 22">
    {visible ? (
      <>
        <Path
          d="M2 11 Q6 5 11 5 Q16 5 20 11 Q16 17 11 17 Q6 17 2 11 Z"
          fill="none"
        ...
        {Array.from({ length: 5 }).map((_, i) => (
          <View
            ...
            style={[
              ...
              { backgroundColor: i < strength ? color : 'rgba(255,255,255,0.06)' },
            ]}
          />
        ))}
      </View>
...
export default function TeacherRegisterScreen() {
  ...
  const validate = (): boolean => {
    ...
    else if (schoolCode.trim().length < 4)
      e.schoolCode = 'School code must be at least 4 characters';
        ...
        <View style={styles.successContainer}>
          ...
          >
            ...
            <Text style={styles.successSubtitle}>
              Welcome, {fullName.split(' ')[0]}! Your teacher account is ready. You can now sign in
              and start managing your class.
            </Text>
        ...
        >
          ...
          <Animated.View style={[styles.headerSection, anim(1)]}>
            ...
            <Text style={styles.subtitle}>
              Set up your teacher account to manage students, track progress, and assign content
            </Text>
          </Animated.View>
            ...
            <Animated.View style={anim(2)}>
              <View style={styles.fieldGroup}>
                ...
                <View style={[styles.inputRow, errors.fullName && styles.inputRowError]}>
                  ...
                  <TextInput
                    style={styles.input}
                    placeholder="e.g. Ms Sarah Jones"
            ...
            <Animated.View style={anim(5)}>
              <View style={styles.fieldGroup}>
                ...
                <Text style={styles.fieldHint}>
                  Your school administrator will have provided this code
                </Text>
              </View>
            </Animated.View>
          ...
          <Animated.View style={anim(8)}>
            ...
            >
              <View style={styles.termsCheckbox}>
                {acceptedTerms ? (
                  <View style={styles.termsChecked}>
                    <Text style={styles.termsCheckmark}>✓</Text>
                  </View>
                ) : (
                  <View
                    style={[
                      styles.termsUnchecked,
                      errors.terms && { borderColor: 'rgba(239,68,68,0.5)' },
                    ]}
                  />
                )}
              </View>
              <Text style={styles.termsText}>
                ...
                <Text style={styles.termsLink}>Privacy Policy</Text>, and confirm I am an authorised
                staff member at the school above.
              </Text>
            </TouchableOpacity>
            {errors.terms && (
              <Text style={[styles.fieldError, { marginLeft: 40 }]}>{errors.terms}</Text>
            )}
          </Animated.View>
          ...
          <Animated.View style={anim(9)}>
            ...
            >
              <LinearGradient
                colors={
                  isLoading
                    ? ['rgba(168,85,247,0.4)', 'rgba(124,58,237,0.3)']
                    : ['#A855F7', '#7C3AED']
                }
                start={{ x: 0, y: 0 }}
                end={{ x: 1, y: 1 }}
          ...
          <Animated.View style={anim(11)}>
            <View style={styles.infoNote}>
              ...
              <Text style={styles.infoNoteText}>
                Teacher accounts require a valid school code for verification. Contact your school
