...
const ALL_BADGES = [
  ...
  },
  {
    ...
    emoji: '📊',
    label: 'Budget Boss',
    description: 'Complete Budgeting island',
    color: '#4FC3F7',
    earned: true,
    date: '3 Feb',
  },
  ...
  },
  {
    ...
    emoji: '🏆',
    label: 'Budget Master',
    description: '4+ stars in simulator',
    color: '#FFD700',
    earned: true,
    date: '5 Feb',
  },
  {
    ...
    emoji: '💪',
    label: 'Resilient',
    description: 'Handle a life event in simulator',
    color: '#10B981',
    earned: true,
    date: '5 Feb',
  },
  {
    ...
    emoji: '🎯',
    label: 'Sharp Saver',
    description: 'Complete Saving Goals island',
    color: '#10B981',
    earned: false,
    date: null,
  },
  {
    ...
    emoji: '🛡️',
    label: 'Scam Proof',
    description: 'Complete Fraud & Scams island',
    color: '#3B82F6',
    earned: false,
    date: null,
  },
  ...
  },
  {
    ...
    emoji: '🏅',
    label: 'Grand Master',
    description: 'Complete all islands',
    color: '#FFD700',
    earned: false,
    date: null,
  },
  ...
  return (
    <View style={styles.chartContainer}>
      <Svg width={CHART_WIDTH} height={chartHeight + 30}>
          ...
          return (
            <G key={val}>
              <Line
                ...
                strokeWidth={1}
              />
              <SvgText x={CHART_WIDTH + 2} y={y + 4} fontSize="9" fill="rgba(255,255,255,0.25)">
                {val}%
              </SvgText>
            </G>
          );
        ...
        <Line
          x1={0}
          y1={chartHeight - (70 / 100) * chartHeight}
          x2={CHART_WIDTH}
          y2={chartHeight - (70 / 100) * chartHeight}
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <Animated.View style={[styles.header, anim(0)]}>
          ...
          <Text style={styles.headerSubtitle}>Keep going, {STUDENT.nickname}! 🚀</Text>
        </Animated.View>
                ...
                <View style={styles.passLineNote}>
                  <View
                    style={[
                      ...
                      { backgroundColor: '#FFD700', width: 10, height: 2, borderRadius: 1 },
                    ]}
                  />
                ...
                <View key={sim.id} style={styles.simRow}>
                  ...
                  <View style={styles.simStars}>
                    {Array.from({ length: 5 }).map((_, i) => (
                      <Text key={i} style={[styles.simStar, i < sim.stars && { opacity: 1 }]}>
                        ⭐
                      </Text>
                    ))}
                  </View>
            ...
            <Animated.View style={anim(6)}>
              <View style={styles.funFactCard}>
                ...
                <Text style={styles.funFactText}>
                  ...
                  <Text style={{ color: '#FFD700', fontFamily: 'Poppins_700Bold' }}>
                    {STUDENT.totalDaysActive} days
                  </Text>{' '}
                  since joining on{' '}
                  ...
                  . That's {STUDENT.missionsCompleted} missions and {STUDENT.simulatorRuns}{' '}
                  simulator runs!
                </Text>
              </View>
            </Animated.View>
          ...
          <>
            <Animated.View style={anim(3)}>
              ...
              <Text style={styles.sectionSubtitle}>
                {ISLANDS.filter((i) => i.progress === 1).length} of {ISLANDS.length} islands
                complete
              </Text>
            </Animated.View>
              ...
              <View style={styles.badgeGrid}>
                {lockedBadges.map((badge) => (
                  <View key={badge.id} style={[styles.badgeCard, { opacity: 0.45 }]}>
                    ...
                    >
                      <View
                        style={[styles.badgeCircle, { backgroundColor: 'rgba(255,255,255,0.06)' }]}
                      >
